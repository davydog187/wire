defmodule Wire.Rainbow do
  ...
  def handle_info(:draw_frame, state) do
    ...
    Blinkchain.set_pixel(%Point{x: 1, y: 0}, c1)
    Blinkchain.set_pixel(%Point{x: 2, y: 0}, c2)
    Blinkchain.set_pixel(%Point{x: 3, y: 0}, c3)
    Blinkchain.set_pixel(%Point{x: 4, y: 0}, c4)
    Blinkchain.set_pixel(%Point{x: 5, y: 0}, c5)
